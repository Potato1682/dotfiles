# Generated by Powerlevel10k configuration wizard on 2022-09-04 at 20:20 JST.
...
# slanted separators, round heads, sharp tails, 2 lines, dotted, right frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    devcontainer            # devcontainer indicator (user-defined, see below)
  ...
  typeset -g POWERLEVEL9K_MY_TRANSIENT_TIME=show
